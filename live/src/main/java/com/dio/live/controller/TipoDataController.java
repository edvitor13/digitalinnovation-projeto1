...
public class TipoDataController {
	...
	public TipoDataService getService() {
		return this.service;
	}
	
	@PostMapping
	public TipoData create(
			@RequestBody TipoData model) 
	{
	...
	@GetMapping("/{id}")
	public ResponseEntity<TipoData> getById(@PathVariable("id") Long id) {
