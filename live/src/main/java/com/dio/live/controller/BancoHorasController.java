...
public class BancoHorasController {
	...
	public BancoHorasService getService() {
		return this.service;
	}
	
	@PostMapping
	public BancoHoras create(
			@RequestBody BancoHoras model) 
	{
	...
	@GetMapping("/{id}")
	public ResponseEntity<BancoHoras> getById(@PathVariable("id") Long id) {
