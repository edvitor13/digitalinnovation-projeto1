...
public class NivelAcessoController {
	...
	public NivelAcessoService getService() {
		return this.service;
	}
	
	@PostMapping
	public NivelAcesso create(
			@RequestBody NivelAcesso model) 
	{
	...
	@GetMapping("/{id}")
	public ResponseEntity<NivelAcesso> getById(@PathVariable("id") Long id) {
